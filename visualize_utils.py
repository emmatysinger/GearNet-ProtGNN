...
class GO():
    def __init__(self, dirname, node_type = 'molecular_function', TxData_inst = None):
        ...
        if TxData_inst:
            ...
            self.TxData_inst = TxData(data_folder_path = '../Data/PrimeKG/')
    ...
    def get_ordered_goids(self):
        ...
        nodes = pd.read_csv('../Data/PrimeKG/nodes.csv')
...
def plot(cluster_list, tsne_results, title= 'Protein Embeddings', colors = None, legend="full", other=True, num_classes=12, transform_type='t-SNE', return_colors=False):
    ...
    ordered_clusters = list(colors.keys())
